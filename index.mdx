---
title: "Introduction"
description: "Welcome to the documentation for PolyVault, a non-custodial, UI-first platform that aggregates and concentrates liquidity on Polymarket. Designed for both ordinary users (Easy Mode) and power users (Pro Mode), PolyVault adds incentives, AI signals, and automated exit/safety options to make providing liquidity seamless and rewarding. This platform is built as a complementary layer on top of Polymarket, respecting its AMM mechanics while enhancing user experience. Key focuses include integration feasibility, capital management, and regulatory compliance. Use the navigation to explore features, architecture, and more.
